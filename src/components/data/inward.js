export const data = [
  {
    ...
    "gender": "female",
    "company": "ADORNICA",
    "email": "lynettemcneil@adornica.com",
    ...
    "friends": [
      ...
      {
        "id": 1,
        "name": "Sharlene Blevins"
      },
      {
        "id": 2,
        "name": "Beverley Lowery"
      }
    ],
    "greeting": "Hello, Lynette Mcneil! You have 7 unread messages.",
    "favoriteFruit": "apple"
  },
  {
    "_id": "111112",
    ...
    "greeting": "Hello, Debra Cruz! You have 1 unread messages.",
  ...
  },
  {
    ...
    "age": 35,
    "eyeColor": "brown",
    "location":"www.ccc.com",
    "orderType": "Chat Order",
    "name": "Cora Wood",
    "gender": "female",
    "company": "OTHERSIDE",
    "email": "corawood@otherside.com",
    ...
    "greeting": "Hello, Cora Wood! You have 1 unread messages.",
    "favoriteFruit": "apple"
  },
  {
    "_id": "111114",
    ...
    "age": 37,
    "eyeColor": "green",
    "location":"www.ddd.com",
    "orderType": "Website Order",
    "name": "Frost Price",
    "gender": "male",
    "company": "OTHERWAY",
    "email": "frostprice@otherway.com",
    ...
    "greeting": "Hello, Frost Price! You have 6 unread messages.",
    "favoriteFruit": "banana"
  },
  {
    "_id": "111115",
    ...
    "age": 38,
    "eyeColor": "green",
    "location":"www.eee.com",
    "orderType": "Chat Order",
    "name": "Helena Winters",
    "gender": "female",
    "company": "PROTODYNE",
    "email": "helenawinters@protodyne.com",
    ...
    "greeting": "Hello, Helena Winters! You have 7 unread messages.",
    "favoriteFruit": "banana"
  },
  {
    "_id": "111116",
    ...
    "age": 38,
    "eyeColor": "brown",
    "location":"www.fff.com",
    "orderType": "Website Order",
    "name": "Elizabeth Booker",
    "gender": "female",
    "company": "PAWNAGRA",
    "email": "elizabethbooker@pawnagra.com",
    ...
    "greeting": "Hello, Elizabeth Booker! You have 5 unread messages.",
    "favoriteFruit": "banana"
  }
]
